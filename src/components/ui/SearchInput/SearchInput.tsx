...
const inputSizeClasses: Record<string, string> = {
  default:
    "block h-[38px] w-full rounded-md border border-input bg-sidebar py-2 pl-10 pr-10 text-foreground placeholder:text-placeholder focus:border-focus focus:outline-none focus:ring-1 focus:ring-ring",
  compact:
