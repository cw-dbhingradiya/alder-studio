    ...
    <>
      ...
      >
        <div className="flex h-16 shrink-0 items-center justify-between px-4">
          <h1 className="text-xl font-bold bg-gradient-to-r from-zinc-600 to-zinc-400 dark:from-zinc-200 dark:to-zinc-400 bg-clip-text text-transparent">
            Alder
          </h1>
          {/* Mobile close button */}
          <button
        ...
        >
          ...
          <button
            ...
            className="cursor-pointer text-xs font-medium text-zinc-500 hover:text-zinc-900 dark:text-zinc-300 dark:hover:text-white"
          >
            Logout
          </button>
        </div>
