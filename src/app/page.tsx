    ...
    <div className="md:p-8 p-4 h-full">
      <div className="md:mb-5 mb-4">
        ...
        <p className="lg:text-base text-sm text-zinc-600 dark:text-[#94969C]">
          Welcome to Alder - your AI image generation workbench
        </p>
      </div>
...
function StatCard({
  ...
  return (
    <Link
      href={href}
      className="flex items-center justify-between rounded-lg border border-zinc-200 bg-white p-6 shadow-sm transition-all hover:shadow-lg hover:shadow-zinc-500/10 dark:border-zinc-600 dark:bg-[#161B26]"
    >
      <div>
      ...
      <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-zinc-200 text-zinc-700 dark:bg-zinc-700 dark:text-zinc-200">
        {icon}
      </div>
    </Link>
  );
...
function QuickActionCard({
  ...
  return (
    <Link
      href={href}
      className="flex items-center gap-4 rounded-lg border border-zinc-200 bg-white p-4 shadow-sm transition-all hover:border-zinc-400 hover:shadow-lg hover:shadow-zinc-500/10 dark:border-zinc-600 dark:bg-[#161B26] dark:hover:border-zinc-400"
    >
      <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-zinc-200 text-zinc-700 dark:bg-zinc-700 dark:text-zinc-200">
        {icon}
      </div>
